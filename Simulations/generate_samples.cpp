...
int main(int argc, char* argv[])
{
 ...
 /************* MAIN PROCESSES *************/
  if(procID == 0){                                                      // Process to finalize calculations
    ...
    std::string filename = generate_unique_filename_eigenvalues(E_TOTAL, LAMBDA_MAX, procID);
 ...
 /************* CALCULATION PROCESSES *************/
    ...
    std::string filename = generate_unique_filename_positions(bfield, particle, procID);
